...
/**
 * Z_FE_FM_CONFIRMA_ESTADO_CUENTA.java
 *
 ...
 */
            ...
            /**
            *  Z_FE_FM_CONFIRMA_ESTADO_CUENTA bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Z_FE_FM_CONFIRMA_ESTADO_CUENTA
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected functions.rfc.sap.document.sap_com.I_ESTADO_type1 localI_ESTADO ;
                                

                           /**
                           * Auto generated getter method
                           * @return functions.rfc.sap.document.sap_com.I_ESTADO_type1
                           */
                           public  functions.rfc.sap.document.sap_com.I_ESTADO_type1 getI_ESTADO(){
                               return localI_ESTADO;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param I_ESTADO
                               */
                               public void setI_ESTADO(functions.rfc.sap.document.sap_com.I_ESTADO_type1 param){
                            
                                            this.localI_ESTADO=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":Z_FE_FM_CONFIRMA_ESTADO_CUENTA",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "Z_FE_FM_CONFIRMA_ESTADO_CUENTA",
                           xmlWriter);
                                           ...
                                           localI_BUKRS.serialize(new javax.xml.namespace.QName("","I_BUKRS"),
                                            ...
                                            if (localI_ESTADO==null){
                                                 throw new org.apache.axis2.databinding.ADBException("I_ESTADO cannot be null!!");
                                            }
                                           localI_ESTADO.serialize(new javax.xml.namespace.QName("","I_ESTADO"),
                                               xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static Z_FE_FM_CONFIRMA_ESTADO_CUENTA parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Z_FE_FM_CONFIRMA_ESTADO_CUENTA object =
                new Z_FE_FM_CONFIRMA_ESTADO_CUENTA();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Z_FE_FM_CONFIRMA_ESTADO_CUENTA".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Z_FE_FM_CONFIRMA_ESTADO_CUENTA)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","I_ESTADO").equals(reader.getName())){
                                
                                                object.setI_ESTADO(functions.rfc.sap.document.sap_com.I_ESTADO_type1.Factory.parse(reader));
