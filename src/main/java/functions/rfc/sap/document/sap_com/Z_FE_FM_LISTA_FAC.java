 ...
 */
            ...
            /**
            *  Z_FE_FM_LISTA_FAC bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Z_FE_FM_LISTA_FAC
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected functions.rfc.sap.document.sap_com.BAPISFLDRA localI_BLDAT ;
                           ...
                           */
                           public  functions.rfc.sap.document.sap_com.BAPISFLDRA getI_BLDAT(){
                               return localI_BLDAT;
                           }
                            ...
                            /**
                               ...
                               * @param param I_BLDAT
                               */
                               public void setI_BLDAT(functions.rfc.sap.document.sap_com.BAPISFLDRA param){
                            
                                            this.localI_BLDAT=param;
                        ...
                        */
                                    ...
                                    protected functions.rfc.sap.document.sap_com.I_ESTATUS_type1 localI_ESTATUS ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localI_ESTATUSTracker = false ;

                           public boolean isI_ESTATUSSpecified(){
                               return localI_ESTATUSTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return functions.rfc.sap.document.sap_com.I_ESTATUS_type1
                           */
                           public  functions.rfc.sap.document.sap_com.I_ESTATUS_type1 getI_ESTATUS(){
                               return localI_ESTATUS;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param I_ESTATUS
                               */
                               public void setI_ESTATUS(functions.rfc.sap.document.sap_com.I_ESTATUS_type1 param){
                            localI_ESTATUSTracker = param != null;
                                   
                                            this.localI_ESTATUS=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":Z_FE_FM_LISTA_FAC",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "Z_FE_FM_LISTA_FAC",
                           xmlWriter);
                                            ...
                                            if (localI_BLDAT==null){
                                                 throw new org.apache.axis2.databinding.ADBException("I_BLDAT cannot be null!!");
                                            }
                                           localI_BLDAT.serialize(new javax.xml.namespace.QName("","I_BLDAT"),
                                               xmlWriter);
                                         ...
                                         if (localI_EKORGTracker){
                                           ...
                                           localI_EKORG.serialize(new javax.xml.namespace.QName("","I_EKORG"),
                                               xmlWriter);
                                        } if (localI_ESTATUSTracker){
                                            if (localI_ESTATUS==null){
                                                 throw new org.apache.axis2.databinding.ADBException("I_ESTATUS cannot be null!!");
                                            }
                                           localI_ESTATUS.serialize(new javax.xml.namespace.QName("","I_ESTATUS"),
                                               xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localI_ESTATUS);
                                } if (localI_IDIOMATracker){
                            elementList.add(new javax.xml.namespace.QName("",
                                                                      "I_IDIOMA"));
    ...
    public static class Factory{
        ...
        */
        public static Z_FE_FM_LISTA_FAC parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Z_FE_FM_LISTA_FAC object =
                new Z_FE_FM_LISTA_FAC();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Z_FE_FM_LISTA_FAC".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Z_FE_FM_LISTA_FAC)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","I_BLDAT").equals(reader.getName())){
                                
                                                object.setI_BLDAT(functions.rfc.sap.document.sap_com.BAPISFLDRA.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","I_ESTATUS").equals(reader.getName())){
                                
                                                object.setI_ESTATUS(functions.rfc.sap.document.sap_com.I_ESTATUS_type1.Factory.parse(reader));
