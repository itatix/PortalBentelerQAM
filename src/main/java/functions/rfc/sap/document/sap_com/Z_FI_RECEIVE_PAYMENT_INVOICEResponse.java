...
/**
 * Z_FI_RECEIVE_PAYMENT_INVOICEResponse.java
 *
 ...
 */
            ...
            /**
            *  Z_FI_RECEIVE_PAYMENT_INVOICEResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Z_FI_RECEIVE_PAYMENT_INVOICEResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "urn:sap-com:document:sap:rfc:functions",
                "Z_FI_RECEIVE_PAYMENT_INVOICE.Response",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":Z_FI_RECEIVE_PAYMENT_INVOICE.Response",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "Z_FI_RECEIVE_PAYMENT_INVOICE.Response",
    ...
    public static class Factory{
        ...
        */
        public static Z_FI_RECEIVE_PAYMENT_INVOICEResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Z_FI_RECEIVE_PAYMENT_INVOICEResponse object =
                new Z_FI_RECEIVE_PAYMENT_INVOICEResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Z_FI_RECEIVE_PAYMENT_INVOICE.Response".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Z_FI_RECEIVE_PAYMENT_INVOICEResponse)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
