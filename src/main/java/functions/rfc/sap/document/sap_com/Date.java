 ...
 */
        ...
        public  class Date extends  org.apache.axis2.databinding.types.Union 
        implements org.apache.axis2.databinding.ADBBean{
              ...
              public void setObject(java.lang.Object object){
                      ...
                      if (object instanceof functions.rfc.sap.document.sap_com.GenericDate){
                            this.localObject = object;
                ...
                writeStartElement(null, parentQName.getNamespaceURI(), parentQName.getLocalPart(), xmlWriter);
                      ...
                      if (localObject instanceof java.util.Date){
                           ...
                           if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                               ...
                               xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString((java.util.Date)localObject));
                           } else 
                      if (localObject instanceof functions.rfc.sap.document.sap_com.GenericDate){
                           ...
                           if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                               ...
                               xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString((functions.rfc.sap.document.sap_com.GenericDate)localObject));
              ...
              public static Date fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                    ...
                    try {
                        if ("http://www.w3.org/2001/XMLSchema".equals(namespaceURI)) {
                            ...
                            object = new Date();
                            object.setObject(functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(namespaceURI, type, xmlStreamReader));
                        }
                        return object;
               ...
               public static Date fromString(java.lang.String value,
                    ...
                    boolean isValueSet = false;
                      ...
                      if (!isValueSet) {
                                ...
                                try {
                                   object.setObject(functions.rfc.sap.document.sap_com.GenericDate.Factory.fromString(value, namespaceURI));
                                   isValueSet = true;
                                } catch (java.lang.Exception e) {
                                }
