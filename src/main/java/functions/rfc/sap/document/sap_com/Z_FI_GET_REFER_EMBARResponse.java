...
/**
 * Z_FI_GET_REFER_EMBARResponse.java
 *
 ...
 */
            ...
            /**
            *  Z_FI_GET_REFER_EMBARResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Z_FI_GET_REFER_EMBARResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "urn:sap-com:document:sap:rfc:functions",
                "Z_FI_GET_REFER_EMBAR.Response",
                "ns1");
                        ...
                        */
                                    ...
                                    protected functions.rfc.sap.document.sap_com.ET_REFER_EMBAR_type1 localET_REFER_EMBAR ;
                                

                           /**
                           * Auto generated getter method
                           * @return functions.rfc.sap.document.sap_com.ET_REFER_EMBAR_type1
                           */
                           public  functions.rfc.sap.document.sap_com.ET_REFER_EMBAR_type1 getET_REFER_EMBAR(){
                            ...
                            /**
                               ...
                               */
                               public void setET_REFER_EMBAR(functions.rfc.sap.document.sap_com.ET_REFER_EMBAR_type1 param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":Z_FI_GET_REFER_EMBAR.Response",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "Z_FI_GET_REFER_EMBAR.Response",
    ...
    public static class Factory{
        ...
        */
        public static Z_FI_GET_REFER_EMBARResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Z_FI_GET_REFER_EMBARResponse object =
                new Z_FI_GET_REFER_EMBARResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Z_FI_GET_REFER_EMBAR.Response".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Z_FI_GET_REFER_EMBARResponse)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","ET_REFER_EMBAR").equals(reader.getName())){
                                                ...
                                                object.setET_REFER_EMBAR(functions.rfc.sap.document.sap_com.ET_REFER_EMBAR_type1.Factory.parse(reader));
