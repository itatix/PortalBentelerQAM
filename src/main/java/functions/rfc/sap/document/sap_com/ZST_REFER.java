 ...
 */
            ...
            /**
            *  ZST_REFER bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ZST_REFER
    ...
    public static class Factory{
        ...
        */
        public static ZST_REFER parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ZST_REFER object =
                new ZST_REFER();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ZST_REFER".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ZST_REFER)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
