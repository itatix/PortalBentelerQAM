 ...
 */
            ...
            /**
            *  Z_FE_FM_CONSULTAR_BUZON bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Z_FE_FM_CONSULTAR_BUZON
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected functions.rfc.sap.document.sap_com.BAPISFLDRA localI_FECHA ;
                           ...
                           */
                           public  functions.rfc.sap.document.sap_com.BAPISFLDRA getI_FECHA(){
                               return localI_FECHA;
                           }
                            ...
                            /**
                               ...
                               * @param param I_FECHA
                               */
                               public void setI_FECHA(functions.rfc.sap.document.sap_com.BAPISFLDRA param){
                            
                                            this.localI_FECHA=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":Z_FE_FM_CONSULTAR_BUZON",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "Z_FE_FM_CONSULTAR_BUZON",
                           xmlWriter);
                                         ...
                                         if (localI_EKORGTracker){
                                           ...
                                           localI_EKORG.serialize(new javax.xml.namespace.QName("","I_EKORG"),
                                            ...
                                            if (localI_FECHA==null){
                                                 throw new org.apache.axis2.databinding.ADBException("I_FECHA cannot be null!!");
                                            }
                                           localI_FECHA.serialize(new javax.xml.namespace.QName("","I_FECHA"),
                                               xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static Z_FE_FM_CONSULTAR_BUZON parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Z_FE_FM_CONSULTAR_BUZON object =
                new Z_FE_FM_CONSULTAR_BUZON();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Z_FE_FM_CONSULTAR_BUZON".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Z_FE_FM_CONSULTAR_BUZON)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","I_FECHA").equals(reader.getName())){
                                
                                                object.setI_FECHA(functions.rfc.sap.document.sap_com.BAPISFLDRA.Factory.parse(reader));
