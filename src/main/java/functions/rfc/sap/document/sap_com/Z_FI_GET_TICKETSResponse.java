 ...
 */
            ...
            /**
            *  Z_FI_GET_TICKETSResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Z_FI_GET_TICKETSResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "urn:sap-com:document:sap:rfc:functions",
                "Z_FI_GET_TICKETS.Response",
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for ET_TICKETS
                        */

                        
                                    protected functions.rfc.sap.document.sap_com.ET_TICKETS_type0 localET_TICKETS ;
                                

                           /**
                           * Auto generated getter method
                           * @return functions.rfc.sap.document.sap_com.ET_TICKETS_type0
                           */
                           public  functions.rfc.sap.document.sap_com.ET_TICKETS_type0 getET_TICKETS(){
                               return localET_TICKETS;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ET_TICKETS
                               */
                               public void setET_TICKETS(functions.rfc.sap.document.sap_com.ET_TICKETS_type0 param){
                            
                                            this.localET_TICKETS=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":Z_FI_GET_TICKETS.Response",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "Z_FI_GET_TICKETS.Response",
                ...
                if (localEV_IDTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localEV_TYPE.serialize(new javax.xml.namespace.QName("","EV_TYPE"),
                                            ...
                                            if (localET_TICKETS==null){
                                                 throw new org.apache.axis2.databinding.ADBException("ET_TICKETS cannot be null!!");
                                            }
                                           localET_TICKETS.serialize(new javax.xml.namespace.QName("","ET_TICKETS"),
                                               xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localEV_IDTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localET_TICKETS);
    ...
    public static class Factory{
        ...
        */
        public static Z_FI_GET_TICKETSResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Z_FI_GET_TICKETSResponse object =
                new Z_FI_GET_TICKETSResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Z_FI_GET_TICKETS.Response".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Z_FI_GET_TICKETSResponse)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","ET_TICKETS").equals(reader.getName())){
                                
                                                object.setET_TICKETS(functions.rfc.sap.document.sap_com.ET_TICKETS_type0.Factory.parse(reader));
