...
/**
 * Z_FE_FM_OBTIENE_DAT_ACCT_PROV.java
 *
 ...
 */
            ...
            /**
            *  Z_FE_FM_OBTIENE_DAT_ACCT_PROV bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Z_FE_FM_OBTIENE_DAT_ACCT_PROV
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "urn:sap-com:document:sap:rfc:functions",
                "Z_FE_FM_OBTIENE_DAT_ACCT_PROV",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":Z_FE_FM_OBTIENE_DAT_ACCT_PROV",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "Z_FE_FM_OBTIENE_DAT_ACCT_PROV",
    ...
    public static class Factory{
        ...
        */
        public static Z_FE_FM_OBTIENE_DAT_ACCT_PROV parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Z_FE_FM_OBTIENE_DAT_ACCT_PROV object =
                new Z_FE_FM_OBTIENE_DAT_ACCT_PROV();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Z_FE_FM_OBTIENE_DAT_ACCT_PROV".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Z_FE_FM_OBTIENE_DAT_ACCT_PROV)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
