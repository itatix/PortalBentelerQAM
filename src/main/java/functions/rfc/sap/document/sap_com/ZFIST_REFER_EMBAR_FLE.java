 ...
 */
            ...
            /**
            *  ZFIST_REFER_EMBAR_FLE bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ZFIST_REFER_EMBAR_FLE
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ZFIST_REFER_EMBAR_FLE
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ZFIST_REFER_EMBAR_FLE",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ZFIST_REFER_EMBAR_FLE",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static ZFIST_REFER_EMBAR_FLE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ZFIST_REFER_EMBAR_FLE object =
                new ZFIST_REFER_EMBAR_FLE();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ZFIST_REFER_EMBAR_FLE".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ZFIST_REFER_EMBAR_FLE)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
