 ...
 */
            ...
            /**
            *  Z_FE_FM_ESTADO_CUENTA bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Z_FE_FM_ESTADO_CUENTA
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":Z_FE_FM_ESTADO_CUENTA",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "Z_FE_FM_ESTADO_CUENTA",
    ...
    public static class Factory{
        ...
        */
        public static Z_FE_FM_ESTADO_CUENTA parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Z_FE_FM_ESTADO_CUENTA object =
                new Z_FE_FM_ESTADO_CUENTA();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Z_FE_FM_ESTADO_CUENTA".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Z_FE_FM_ESTADO_CUENTA)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
