 ...
 */
            ...
            /**
            *  Z_FE_FM_DIVISIONResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Z_FE_FM_DIVISIONResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "urn:sap-com:document:sap:rfc:functions",
                "Z_FE_FM_DIVISIONResponse",
                "ns1");
                        ...
                        */
                                    ...
                                    protected functions.rfc.sap.document.sap_com.ZTT_DIV_LIST localE_DIVLIST ;
                                

                           /**
                           * Auto generated getter method
                           * @return functions.rfc.sap.document.sap_com.ZTT_DIV_LIST
                           */
                           public  functions.rfc.sap.document.sap_com.ZTT_DIV_LIST getE_DIVLIST(){
                               return localE_DIVLIST;
                           }
                            ...
                            /**
                               ...
                               * @param param E_DIVLIST
                               */
                               public void setE_DIVLIST(functions.rfc.sap.document.sap_com.ZTT_DIV_LIST param){
                            
                                            this.localE_DIVLIST=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":Z_FE_FM_DIVISIONResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "Z_FE_FM_DIVISIONResponse",
                           xmlWriter);
                                            ...
                                            if (localE_DIVLIST==null){
                                                 throw new org.apache.axis2.databinding.ADBException("E_DIVLIST cannot be null!!");
                                            }
                                           localE_DIVLIST.serialize(new javax.xml.namespace.QName("","E_DIVLIST"),
                                               xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localE_DIVLIST);
    ...
    public static class Factory{
        ...
        */
        public static Z_FE_FM_DIVISIONResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Z_FE_FM_DIVISIONResponse object =
                new Z_FE_FM_DIVISIONResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Z_FE_FM_DIVISIONResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Z_FE_FM_DIVISIONResponse)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","E_DIVLIST").equals(reader.getName())){
                                
                                                object.setE_DIVLIST(functions.rfc.sap.document.sap_com.ZTT_DIV_LIST.Factory.parse(reader));
