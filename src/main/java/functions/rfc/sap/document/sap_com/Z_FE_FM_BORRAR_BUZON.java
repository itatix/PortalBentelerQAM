 ...
 */
            ...
            /**
            *  Z_FE_FM_BORRAR_BUZON bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Z_FE_FM_BORRAR_BUZON
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected functions.rfc.sap.document.sap_com.I_CTRLID_type1 localI_CTRLID ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localI_CTRLIDTracker = false ;

                           public boolean isI_CTRLIDSpecified(){
                               return localI_CTRLIDTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return functions.rfc.sap.document.sap_com.I_CTRLID_type1
                           */
                           public  functions.rfc.sap.document.sap_com.I_CTRLID_type1 getI_CTRLID(){
                               return localI_CTRLID;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param I_CTRLID
                               */
                               public void setI_CTRLID(functions.rfc.sap.document.sap_com.I_CTRLID_type1 param){
                            localI_CTRLIDTracker = param != null;
                                   
                                            this.localI_CTRLID=param;
                        ...
                        */
                                    ...
                                    protected functions.rfc.sap.document.sap_com.I_EBELN_type1 localI_EBELN ;
                                

                           /**
                           * Auto generated getter method
                           * @return functions.rfc.sap.document.sap_com.I_EBELN_type1
                           */
                           public  functions.rfc.sap.document.sap_com.I_EBELN_type1 getI_EBELN(){
                               return localI_EBELN;
                           }
                            ...
                            /**
                               ...
                               * @param param I_EBELN
                               */
                               public void setI_EBELN(functions.rfc.sap.document.sap_com.I_EBELN_type1 param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":Z_FE_FM_BORRAR_BUZON",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "Z_FE_FM_BORRAR_BUZON",
                           xmlWriter);
                                           ...
                                           localI_BUKRS.serialize(new javax.xml.namespace.QName("","I_BUKRS"),
                                               xmlWriter);
                                         if (localI_CTRLIDTracker){
                                            if (localI_CTRLID==null){
                                                 throw new org.apache.axis2.databinding.ADBException("I_CTRLID cannot be null!!");
                                            }
                                           localI_CTRLID.serialize(new javax.xml.namespace.QName("","I_CTRLID"),
                                               xmlWriter);
                                        }
    ...
    public static class Factory{
        ...
        */
        public static Z_FE_FM_BORRAR_BUZON parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Z_FE_FM_BORRAR_BUZON object =
                new Z_FE_FM_BORRAR_BUZON();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Z_FE_FM_BORRAR_BUZON".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Z_FE_FM_BORRAR_BUZON)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","I_CTRLID").equals(reader.getName())){
                                
                                                object.setI_CTRLID(functions.rfc.sap.document.sap_com.I_CTRLID_type1.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","I_EBELN").equals(reader.getName())){
                                                ...
                                                object.setI_EBELN(functions.rfc.sap.document.sap_com.I_EBELN_type1.Factory.parse(reader));
