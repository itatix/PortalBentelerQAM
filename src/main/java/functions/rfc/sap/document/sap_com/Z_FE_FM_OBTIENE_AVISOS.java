 ...
 */
            ...
            /**
            *  Z_FE_FM_OBTIENE_AVISOS bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Z_FE_FM_OBTIENE_AVISOS
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for I_TIPO_AVISO
                        */

                        
                                    protected functions.rfc.sap.document.sap_com.I_TIPO_AVISO_type1 localI_TIPO_AVISO ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localI_TIPO_AVISOTracker = false ;

                           public boolean isI_TIPO_AVISOSpecified(){
                               return localI_TIPO_AVISOTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return functions.rfc.sap.document.sap_com.I_TIPO_AVISO_type1
                           */
                           public  functions.rfc.sap.document.sap_com.I_TIPO_AVISO_type1 getI_TIPO_AVISO(){
                               return localI_TIPO_AVISO;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param I_TIPO_AVISO
                               */
                               public void setI_TIPO_AVISO(functions.rfc.sap.document.sap_com.I_TIPO_AVISO_type1 param){
                            localI_TIPO_AVISOTracker = param != null;
                                   
                                            this.localI_TIPO_AVISO=param;
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":Z_FE_FM_OBTIENE_AVISOS",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "Z_FE_FM_OBTIENE_AVISOS",
                ...
                if (localI_BUKRSTracker){
                                           ...
                                           localI_LIFNR.serialize(new javax.xml.namespace.QName("","I_LIFNR"),
                                               xmlWriter);
                                        } if (localI_TIPO_AVISOTracker){
                                            if (localI_TIPO_AVISO==null){
                                                 throw new org.apache.axis2.databinding.ADBException("I_TIPO_AVISO cannot be null!!");
                                            }
                                           localI_TIPO_AVISO.serialize(new javax.xml.namespace.QName("","I_TIPO_AVISO"),
                                               xmlWriter);
                                        }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localI_BUKRSTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localI_TIPO_AVISO);
                                }
    ...
    public static class Factory{
        ...
        */
        public static Z_FE_FM_OBTIENE_AVISOS parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Z_FE_FM_OBTIENE_AVISOS object =
                new Z_FE_FM_OBTIENE_AVISOS();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Z_FE_FM_OBTIENE_AVISOS".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Z_FE_FM_OBTIENE_AVISOS)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","I_TIPO_AVISO").equals(reader.getName())){
                                
                                                object.setI_TIPO_AVISO(functions.rfc.sap.document.sap_com.I_TIPO_AVISO_type1.Factory.parse(reader));
