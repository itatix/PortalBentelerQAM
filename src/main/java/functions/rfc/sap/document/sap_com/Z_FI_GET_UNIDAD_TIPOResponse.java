...
/**
 * Z_FI_GET_UNIDAD_TIPOResponse.java
 *
 ...
 */
            ...
            /**
            *  Z_FI_GET_UNIDAD_TIPOResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Z_FI_GET_UNIDAD_TIPOResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "urn:sap-com:document:sap:rfc:functions",
                "Z_FI_GET_UNIDAD_TIPO.Response",
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for ET_UNIDAD_TIPO
                        */

                        
                                    protected functions.rfc.sap.document.sap_com.ET_UNIDAD_TIPO_type1 localET_UNIDAD_TIPO ;
                                

                           /**
                           * Auto generated getter method
                           * @return functions.rfc.sap.document.sap_com.ET_UNIDAD_TIPO_type1
                           */
                           public  functions.rfc.sap.document.sap_com.ET_UNIDAD_TIPO_type1 getET_UNIDAD_TIPO(){
                               return localET_UNIDAD_TIPO;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ET_UNIDAD_TIPO
                               */
                               public void setET_UNIDAD_TIPO(functions.rfc.sap.document.sap_com.ET_UNIDAD_TIPO_type1 param){
                            
                                            this.localET_UNIDAD_TIPO=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":Z_FI_GET_UNIDAD_TIPO.Response",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "Z_FI_GET_UNIDAD_TIPO.Response",
                ...
                if (localEV_IDTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localEV_TYPE.serialize(new javax.xml.namespace.QName("","EV_TYPE"),
                                            ...
                                            if (localET_UNIDAD_TIPO==null){
                                                 throw new org.apache.axis2.databinding.ADBException("ET_UNIDAD_TIPO cannot be null!!");
                                            }
                                           localET_UNIDAD_TIPO.serialize(new javax.xml.namespace.QName("","ET_UNIDAD_TIPO"),
                                               xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localEV_IDTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localET_UNIDAD_TIPO);
    ...
    public static class Factory{
        ...
        */
        public static Z_FI_GET_UNIDAD_TIPOResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Z_FI_GET_UNIDAD_TIPOResponse object =
                new Z_FI_GET_UNIDAD_TIPOResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Z_FI_GET_UNIDAD_TIPO.Response".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Z_FI_GET_UNIDAD_TIPOResponse)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","ET_UNIDAD_TIPO").equals(reader.getName())){
                                
                                                object.setET_UNIDAD_TIPO(functions.rfc.sap.document.sap_com.ET_UNIDAD_TIPO_type1.Factory.parse(reader));
