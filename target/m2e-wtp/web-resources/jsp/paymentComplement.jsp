...
<script type="text/javascript" src="<%= URL_AppRelative %>/js/paymentComplement.js"></script>
<style>
  ...
  <div class="navbar-inner">    
    <div class="container" style="width: auto;">        
      ...
      <% } %>
        ...
        <li class="active"><a id="fat-menu" href="<%= URL_AppRelative%>/PaymentComplement?language=${pageContext.response.locale}" role="button"><spring:message code="menu.paymentcomplement"/></a></li>                  
