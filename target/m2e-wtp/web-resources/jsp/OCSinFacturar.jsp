...
<title>Orden de Compra Sin Facturar</title>
<meta charset="UTF-8">
...
<script type="text/javascript" src="<%= URL_AppRelative %>/js/ordenCompraSinFacturar.js"></script>
<style>
  ...
  <div class="navbar-inner">  	
    <div class="container" style="width: auto;">     	
      ...
      <% if(menusDto.getListaOC()) { %>
        <li class="active"> <a id="fat-menu" href="<%= URL_AppRelative%>/OCSinFacturar?language=${pageContext.response.locale}" role="button"><spring:message code="menu.pendinginvoices"/></a></li>
      <% } %>
