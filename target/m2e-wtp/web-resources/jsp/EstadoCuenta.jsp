...
<script type="text/javascript" src="<%= URL_AppRelative %>/js/estadoCuenta.js"></script>
<style>
  ...
  <div class="navbar-inner">  	
    <div class="container" style="width: auto;">     	
      ...
      <% if(menusDto.getEstadoCuenta()) { %>
      	<li class="active"><a href="<%= URL_AppRelative %>/EstadoCuenta?language=${pageContext.response.locale}" id="drop2" role="button" class=""><spring:message code="menu.accountstatus"/></a></li>
      <% } %>
