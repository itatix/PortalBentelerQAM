...
<html>
<head>
<title>Envío de factura sin orden de compra - CFD/CFDI - Magna COSMA</title>
...
<link rel="stylesheet" type="text/css" href="<%= URL_AppRelative %>/resources/css/RowEditor.css"/>
<script type="text/javascript" src="<%= URL_AppRelative %>/resources/sencha/adapter/ext/ext-base.js"></script>
<script type="text/javascript" src="<%= URL_AppRelative %>/resources/sencha/ext/ext-all-debug.js"></script>
...
<script type="text/javascript" src="<%= URL_AppRelative %>/js/ux/GridEditorField.js"></script>
<script type="text/javascript" src="<%= URL_AppRelative %>/js/ux/RowEditor.js"></script>
<script type="text/javascript" src="<%= URL_AppRelative %>/js/cfdiAgencias.js"></script>
<style>
...
<!--          end help menu -->
<%-- <span class="pull-right label label-default" style="margin-top: 5px; padding: 5px 60px; font-size: 15px; clear: right;"><spring:message code="label.provider"/> <%= currentUser.getUsername() %> <%= currentUser.getProviderName() %></span> --%>
...
<%--                     <% if (menusDto.getSocCFDIFletes()) { %> --%>
                    <li><a tabindex="-1" href="<%= URL_AppRelative%>/soc/cfdiFletes?language=${pageContext.response.locale}">• <spring:message code="submenu.cfdifreight"/></a></li>
<%--                     <% } %> --%>
...
<%--                     <% } %> --%>
<%--                     <% if (menusDto.getSocCBBFletes()) { %> --%>
                    <li><a tabindex="-1" href="<%= URL_AppRelative%>/soc/scfdiFletes?language=${pageContext.response.locale}">• <spring:message code="submenu.cbbfreight"/></a></li>
<%--                     <% } %> --%>
<%--                 <% } %> --%>
