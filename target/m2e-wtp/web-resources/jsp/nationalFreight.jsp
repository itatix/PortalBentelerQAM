...
<%
if("US".equals(currentUser.geteLand().toUpperCase())) {
%>
<script type="text/javascript" src="<%= URL_AppRelative %>/js/foreignInbox.js"></script>
<%} else { %>
<script type="text/javascript" src="<%= URL_AppRelative %>/js/nationalInbox.js"></script>
<%} %>
<style>
  ...
  <div class="navbar-inner">    
    <div class="container" style="width: auto;">        
      ...
      <% if (menusDto.getSocCFDIFletes()) { %>
         <li class="active"><a href="<%= URL_AppRelative %>/Freight?language=${pageContext.response.locale}" id="drop2" role="button" class=""><spring:message code="menu.Freight"/></a></li>
      <% } %>
      <% if(menusDto.isInbox()) { %>
...
<script type="text/javascript" src="<%= URL_AppRelative %>/js/ux/bPopup.js"></script>
<script>
