...
<script type="text/javascript" src="<%= URL_AppRelative %>/js/scfdici.js"></script>
<style>
  ...
  <div class="navbar-inner">  	
    <div class="container" style="width: auto;">     	
      ...
      <% if(menusDto.getAvisos()) { %>
      	<li><a href="<%= URL_AppRelative %>/avisos?language=${pageContext.response.locale}" id="drop2" role="button" class=""><spring:message code="menu.notifications"/></a></li>
      <% } %>
      </ul> 
