...
<html>
<head>
<title>Envío de factura sin orden de compra - CFD/CFDI</title>
...
<script type="text/javascript" src="<%= URL_AppRelative %>/js/cfdisoc.js"></script>
<style>
...
<div id="navbar-example" class="navbar navbar-static" style="z-index:1000;">
  <div class="navbar-inner">  	
    <div class="container" style="width: auto;">     	
      ...
      <% } %>
        <li> <a id="fat-menu" href="<%= URL_AppRelative%>/ListaFacturas?language=${pageContext.response.locale}" role="button"><spring:message code="menu.invoicelist"/></a></li>
