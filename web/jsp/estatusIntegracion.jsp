...
<title>Estatus de Recepción</title>
<meta charset="UTF-8">
...
<script type="text/javascript" src="<%= URL_AppRelative %>/js/estatusIntegracion.js"></script>
<style>
  ...
  <div class="navbar-inner">  	
    <div class="container" style="width: auto;">     	
      ...
      <% if(menusDto.getEstatusRecepcion()) { %>
      	<li class="active"><a href="<%= URL_AppRelative %>/EstatusRecepcion?language=${pageContext.response.locale}" id="drop2" role="button" class=""><spring:message code="menu.receptionstatus"/></a></li>
      <% } %>
